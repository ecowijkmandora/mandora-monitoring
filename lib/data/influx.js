...
const ITHO_CSV_MEASUREMENT_ENERGY = ITHO_CSV_MEASUREMENT_PREFIX + config.itho.csv.import.energy_installation.measurement
const ITHO_CSV_MEASUREMENT_TEMPERATURE_ENV = ITHO_CSV_MEASUREMENT_PREFIX + config.itho.csv.import.temperature_env.measurement
const ITHO_CSV_MEASUREMENT_TEMPERATURE_BOILER = ITHO_CSV_MEASUREMENT_PREFIX + config.itho.csv.import.temperature_boiler.measurement
